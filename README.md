...
## 3)Таблица с информацией по выбранным кластерам 
 ...
 Я опишу только 2 кластера: 1 и 2.
Информацию zh-score и кластерах также находится в колабе
Про protein_id брала информацию из gbff файлов, их открытие я из колаба удалила, потому что эти ячейки занимают очень много места
